...
function doGridClick(data){
	  skhid = data["KHID"];
	  Efs.getExt("jtqkAdd").enable();
	  Efs.getExt("zcjgAdd").enable();
	  Efs.getExt("xzcjAdd").enable();
...
<body>
	...
	<div id="xsGrid" region="center" border="flase" xtype="grid" iconCls="icon-panel" onEfsRowClick="doGridClick() pagingBar="true" pageSize="20">
	   <div xtype="tbar">
		  ...
		  <div text="->"></div>
		  <div iconCls="icon-add" id="jtqkAdd" text="家庭情况新增#A" onEfsClick="onAddJt()" disabled="disabled"></div>
		  <div iconCls="icon-add" id="zcjgAdd" text="资产结构新增#A" onEfsClick="onAddZc()" disabled="disabled"></div>
		  <div iconCls="icon-add" id="xzcjAdd" text="新增成交记录#A" onEfsClick="onAddLscj()" disabled="disabled"></div>
	   </div>
	...
	<div iconCls="icon-panel" id="win1" xtype="window" width="800" height="400" title="家庭情况编辑窗口" resizable="true" modal="true">
	  <div region="north" xtype="panel" title="" border="false" height="105" autoScroll="true">
	    <div xtype="tbar">
	      <div text="->"></div>
	      <div iconCls="icon-add" id="cmdUser" text="确定新增" onEfsClick="doJtqkOk()"></div>
	    </div>
	    ...
	    <TABLE>
	      ...
	      <tr>
	        ...
	        <td><input type="text"  class="Edit" kind="text" fieldname="T_JTQK/BZ" must="true" state="0" datatype="0"></td>
	   		 ...
	   		 <input type="hidden"  id="pid1" kind="text" fieldname="T_JTQK/KHID" operation="0" writeevent="0" state="0" datatype="0">
	    </form>
	  </div>
	  <!-- 家庭情况Grid -->
	  <div id="xsGrid1"  region="center" border="flase" xtype="grid" iconCls="icon-panel" >
	   <div id="xsStore1" xtype="store" url="<%=rootPath%>/zxkh_getJtqkList.action" txtXML="" autoLoad="false">
