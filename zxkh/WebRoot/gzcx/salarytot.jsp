...
<%
  ...
  ArrayList al6 = GzcxBO.getSum("wagedetailtpl",userSession);
  //获取字段名
  ArrayList al1 = GzcxBO.getCurDbfld("salarytottpl",userSession);
  //获取字段显示名称
  ArrayList al2 = GzcxBO.getCurFldname("salarytottpl",userSession);
  //获取字段显示宽度
  ArrayList al3 = GzcxBO.getCurFldwidth("salarytottpl",userSession);
  ArrayList al5 = GzcxBO.getNoShowDbfld("salarytottpl", userSession);
...
<body>
<div region="north" height="60" title="薪酬合计汇总信息" collapsible="false">
...
<tr>
	...
	<input type="hidden" name="tpl" fieldname="TPL" value="salarytottpl"/>
	<input type="hidden" name="tpl" fieldname="TPLDETAIL" value="wagedetailtpl"/>
</form>
</div>
