...
<%
  ...
  //获取字段名
  ArrayList al1 = GzcxBO.getCurDbfld("wagetottpl",userSession);
  //获取字段显示名称
  ArrayList al2 = GzcxBO.getCurFldname("wagetottpl",userSession);
  //获取字段显示宽度
  ArrayList al3 = GzcxBO.getCurFldwidth("wagetottpl",userSession);
  ArrayList al5 = GzcxBO.getNoShowDbfld("wagetottpl", userSession);
...
<body>
<div region="north" height="60" title="工资汇总信息" collapsible="false">
...
<tr>
	...
	<input type="hidden" name="tpl" fieldname="TPL" value="wagetottpl"/>
