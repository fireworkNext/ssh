...
public class Field
{
  ...
  public static final String PARENTID                       = "PARENTID";                     /// 上级事务类型
  public static final String SYSTEMID                       = "SYSTEMID";                     /// 所属应用系统
  ...
  public static final String PRINTFLAG		                = "PRINTFLAG";        		      /// 是否打印工资单
  ...
  public static final String BXDM                           = "BXDM";                         /// 保险代码
  public static final String MANAGEDORG                     = "MANAGEDORG";                   /// 保险代码
  public static final String BMMC                           = "BMMC";                         /// 保险代码
  public static final String DEPTID							= "DEPTID";						  /// 用户部门编号
  public static final String DEPTNAME						= "DEPTNAME";					  /// 用户部门名称
  ...
  public static final String JGBM							= "JGBM";						  ///
  ...
  public static final String DIC_ORD                        = "DIC_ORD";                      /// 字典顺序
  ...
  ////////////设备基本信息表字段
  public static final String SBBH                         = "SBBH";                       /// 设备编号
  public static final String SJSBBH                       = "SJSBBH";                     /// 上级设备编号
  public static final String SBSX                       = "SBSX";                     /// 设备属性
  public static final String GDZCBH                      = "GDZCBH";                    /// 固定资产编号
  public static final String SBLX                       = "SBLX";                     /// 设备类型
  public static final String SBMC                   = "SBMC";                 /// 设备名称
  
  ////////////设备扩展信息表字段
  public static final String SBKZXXID                       = "SBKZXXID";                     /// 设备扩展信息id
  public static final String KZXXID                       = "KZXXID";                     /// 扩展信息id
  public static final String KZXXTEXT                       = "KZXXTEXT";                     /// 扩展信息值
}
