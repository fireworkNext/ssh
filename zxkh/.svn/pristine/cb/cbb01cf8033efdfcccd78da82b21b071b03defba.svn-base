...
<%
  ...
  ArrayList al6 = GzcxBO.getSum("otherdetailtpl",userSession);
  //获取字段名
  ArrayList al1 = GzcxBO.getCurDbfld("othertottpl",userSession);
  //获取字段显示名称
  ArrayList al2 = GzcxBO.getCurFldname("othertottpl",userSession);
  //获取字段显示宽度
  ArrayList al3 = GzcxBO.getCurFldwidth("othertottpl",userSession);
  ArrayList al5 = GzcxBO.getNoShowDbfld("othertottpl", userSession);
...
<body>
<div region="north" height="60" title="其他汇总信息" collapsible="false">
...
<tr>
	...
	<input type="hidden" name="tpl" fieldname="TPL" value="othertottpl"/>
	<input type="hidden" name="tpl" fieldname="TPLDETAIL" value="otherdetailtpl"/>
</form>
</div>
